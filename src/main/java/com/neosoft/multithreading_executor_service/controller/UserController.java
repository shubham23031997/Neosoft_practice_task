package com.neosoft.multithreading_executor_service.controller;
...
public class UserController {
    ...
    //here  we split task by multiple thread and join then to get response
    ...
    public ResponseEntity getUsers() {
        ...
        System.out.println(service.findAllUsers().thenApply(ResponseEntity::ok));
